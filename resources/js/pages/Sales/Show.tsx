...
export default function InvoiceShow({ invoice }) {
  ...
  <div className="text-right space-y-1 text-sm">
    ...
    <p>الفرع: <span className="font-semibold">{invoice.branch?.name || "غير محدد"}</span></p>
  </div>
</div>
        ...
        <div>
          <Card>
            ...
            <CardContent className="space-y-2 text-sm">
              <div className="flex justify-between"><span>الإجمالي (قبل الخصم):</span> <span>{invoice.subtotal}</span></div>
              <div className="flex justify-between"><span>قيمة الخصم:</span> <span>{invoice.discount_percentage}%</span></div>
              <div className="flex justify-between"><span>بعد الخصم:</span> <span>{invoice.after_discount}</span></div>
              ...
              <div className="flex justify-between"><span>تم تحصيل:</span> <span>{invoice.collected}</span></div>
              <div className="flex justify-between"><span>المؤجل:</span> <span>{invoice.postponed}</span></div>
            </CardContent>
          </Card>
        </div>
      </div>
