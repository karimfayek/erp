          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6" dir="rtl">
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div className="text-sm">المحصّل: <span className="font-medium">{inv.collected_amount}</span></div>
                <div className="text-sm">المؤجل: <span className="font-medium">{inv.remaining_amount}</span></div>
